<!--
 * @Author: your name
 * @Date: 2020-03-26 16:06:09
 * @LastEditTime: 2020-05-12 16:41:38
 * @LastEditors: Please set LastEditors
 * @Description: 办事主题选择
 * @FilePath: \smart-app\src\components\workingTheme.vue
 -->
...
export default {
  ...
  computed: {
    list() {
      return this.$store.state.workingTheme;
    }
  },
  created() {
    // 请求后台获取办事主题数据
    this.$store.dispatch("fetchWorkingTheme", data => {
      // 默认选择
